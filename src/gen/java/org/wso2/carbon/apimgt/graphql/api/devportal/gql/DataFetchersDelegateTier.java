 ...
 */
public interface DataFetchersDelegateTier {
	
	/**
	 * This method loads the data for Tier.tierDetails. 
	 * <BR/>
	 * <BR/>
	 * 
	 ...
	 * @param origin 
	 *    The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch the tierDetails attribute
	 *    of the <I>origin</I>, which is an instance of {Tier}. It depends on your data modle, but it typically contains 
	 ...
	 */
	public List<TierDetails> tierDetails(DataFetchingEnvironment dataFetchingEnvironment, Tier origin);
