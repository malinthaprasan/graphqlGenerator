 ...
 */
public interface DataFetchersDelegateIngressUrl {
	
	/**
	 * This method loads the data for IngressUrl.clusterDetails. 
	 * <BR/>
	 * <BR/>
	 * 
	 ...
	 * @param origin 
	 *    The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch the clusterDetails attribute
	 *    of the <I>origin</I>, which is an instance of {IngressUrl}. It depends on your data modle, but it typically contains 
	 ...
	 */
	public List<DeploymentClusterInformation> clusterDetails(DataFetchingEnvironment dataFetchingEnvironment, IngressUrl origin);
