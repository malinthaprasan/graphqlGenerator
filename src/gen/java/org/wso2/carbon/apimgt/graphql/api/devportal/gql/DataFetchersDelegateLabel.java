 ...
 */
public interface DataFetchersDelegateLabel {
	
	/**
	 * This method loads the data for Label.labelDetails. 
	 * <BR/>
	 * <BR/>
	 * 
	 ...
	 * @param origin 
	 *    The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch the labelDetails attribute
	 *    of the <I>origin</I>, which is an instance of {Label}. It depends on your data modle, but it typically contains 
	 ...
	 */
	public List<LabelDetails> labelDetails(DataFetchingEnvironment dataFetchingEnvironment, Label origin);
